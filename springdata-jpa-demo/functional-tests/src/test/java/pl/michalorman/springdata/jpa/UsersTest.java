package pl.michalorman.springdata.jpa;
...
public class UsersTest {
    ...
    public void testConnection() throws Exception {
        ...
        WebRequest request = new GetMethodWebRequest("http://localhost:8081/springdata-jpa-demo-functional-tests/users");
        try {
    ...
    public void testCreate() throws Exception {
        WebConversation conversation = new WebConversation();
        WebRequest request = new PostMethodWebRequest("http://localhost:8081/springdata-jpa-demo-functional-tests/users");
        ...
        request = new GetMethodWebRequest("http://localhost:8081/springdata-jpa-demo-functional-tests/users/" + userId);
